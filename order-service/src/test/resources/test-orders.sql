...
insert into orders(id, order_number, username,
                   ...
                   status, comments)
values (1, 'order-123', 'user', 'ozdemir', 'ozdemir@ozdemir.com', '123123123',
        'istanbul', 'istanbul', 'istanbul', 'istanbul', 3400, 'türkiye', 'NEW', ''),
       (2, 'order-456', 'user', 'ozdemir', 'ozdemir@ozdemir.com', '123123123',
        'istanbul', 'istanbul', 'istanbul', 'istanbul', 3400, 'türkiye', 'NEW', '');
